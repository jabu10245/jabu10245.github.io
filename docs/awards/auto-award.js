const COTM_USERNAME = "Major_Postal".toLowerCase();
const MPOTM_USERNAME = "davidalexander82".toLowerCase();
const BOTM_USERNAME = "shylrai".toLowerCase();
const IBTCOTM_USERNAME = "Jabu10245".toLowerCase();
const MONTH = "2024-10";
